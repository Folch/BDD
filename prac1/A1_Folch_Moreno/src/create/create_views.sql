...
SELECT h.nom as Hotel,h.direccio,s.nom as Sala,(s.aforament - e.entradesvenudes) as Entrades_disponibles, j.id AS jornada,j.datainici,j.datafi,p.jblanques AS Jugador_blanques,p.jnegres AS Jugador_negres,p.victoria,p.jutge
